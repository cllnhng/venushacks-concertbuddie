...
def genre_artist(name):
    ...
    list_of_things_to_bring = {
        ...
        'edm': ['wallet','photo id','fan','phone & charger','water bottle','ear plugs', 'sunglasses', 'small bag' ],
        'k-pop': ['cash','phone & charger','sweater','water bottle', 'light stick', 'clear bag','merch','photocards'],
    ...
    genres = genre_of_artist
    artistname = name_of_artist
    item_list = is_genre_in_list()
    
    return [item_list, genres, artistname]